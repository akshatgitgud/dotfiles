...
-- HyprPanel --
hl.bind("CTRL + ESCAPE", hl.dsp.exec_cmd([[killall "gjs" || hyprpanel]]))

-- Screenshots --
local ss = "/home/monkey/screenshots"

hl.bind("PRINT", hl.dsp.exec_cmd("grimblast copysave screen " .. ss .. "/$(date +'%Y-%m-%d_%H-%M-%S').png"))

hl.bind("SUPER + PRINT", hl.dsp.exec_cmd("grimblast copysave active " .. ss .. "/$(date +'%Y-%m-%d_%H-%M-%S').png"))

hl.bind("SUPER + ALT + PRINT", hl.dsp.exec_cmd("grimblast copysave area " .. ss .. "/$(date +'%Y-%m-%d_%H-%M-%S').png"))
...
hl.window_rule({
	...
	match = {
		class = "^(clipse)$",
		title = "^(clipse-floating)$",
	},
	float = true,
	move = { 0, 0 },
	size = { "monitor_w", "monitor_h" }, -- fills the active monitor
	opacity = "0.6 override 0.7 override",
})
